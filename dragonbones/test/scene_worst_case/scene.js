...
(lib.orange_mouth_talk = function(mode,startPosition,loop) {
	...
	this.shape_8.graphics.f().s("#D18B25").ss(2,1,1).p("AAzhIQAWAeAAAqQAAAqgWAfQgVAegeAAQgdAAgWgeQgVgfAAgqQAAgqAVgeQAWgfAdAAQAeAAAVAfg");
	...
	this.shape_12.graphics.f().s("#D18B25").ss(2,1,1).p("AAAjTQA+AAArA+QAtA/AABWQAABYgtA+QgrA+g+AAQg9AAgsg+Qgsg+AAhYQAAhWAsg/QAsg+A9AAg");
...
(lib.bluePlanet = function() {
	...
	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#243F7B").s().p("AgvAWIgBgBQABgKgFgDQAFgGAEgGIAAgBQAPgRAdgCIABAAQAGAFAJADIAAABQAGABAEgCIABAAQACAEAKgBIABAAIAAAAIAMADQgDAGgGADQgTAEgSAJQAAgBAAAAQAAgBAAAAQAAAAgBAAQAAAAgBAAQgQAFgRAIIgBAAIgMABIAAABQgEAAgCgDgAgZgBIAAABIgDAEIAAABIACAHIABAAQAXACAEgSIAAgBQABgGgDgBIAAgBQgPABgKALg");
	this.shape_38.setTransform(16.5,31.9);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#124C7B").s().p("");
	this.shape_39.setTransform(17,32);
	...
	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#88AED7").s().p("");
	this.shape_46.setTransform(19.6,28.3);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("#A4C3E7").s().p("AhABMIACgBQgDgGgMACIAAgBQATgDAKgKIgBAAQgFgDAEgCIAAgBQAFgEAHgCIABgBQAQgCAUABIAAAAIgQAKIAAAAQgGAOgOAGQgJADgKAAIgIAAgAAQgyIAHgEQAAgBABAAQAAgBAAAAQAAAAAAAAQgBAAAAAAQgMABgCgHIACgBIAAgBQADgCADgBIABgBIAAAAQAagLAeAGIAAAAIgLAJIAAABQAKAAAFAEQgaAEgYAGIgHABQgEAAgBgCg");
	this.shape_47.setTransform(20.7,30.9);
	...
	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#3E719B").s().p("AhcA5Qg6gKgogaIAAgBQATgLAOgNIAEgEQARgLAYACQALgEAGgIIABgBQAMADAXABQA5ACAfgXQAEgDAHgBQAMABAJgGIAAgBQARACASgCIABAAQASAMAWgFQAGgCgCAGQAIADAMgDIABAAQAMAJAQAFIABAAIAAABIgMAPIAAABIAAABIgBAAQgWgFgPAIQAHAKAMACIABABIAAAAQgSAWgaAOIAAABQgbgKglgCQhagGg3Akg");
	this.shape_58.setTransform(32.5,54.6);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#366B92").s().p("");
	this.shape_59.setTransform(37.9,54.4);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#6A90C7").s().p("AgDAGIgBAAQgFgDgDgEIgBAAQgDABgFgFIAAgBQAKgGALAKIAAAAQAKgEAMAEIAAAAQgBAGgEAEIgBAAIgIABQgHAAgEgDg");
	this.shape_60.setTransform(44.4,47.1);
	...
	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#335586").s().p("");
	this.shape_72.setTransform(59.3,19.2);
	...
	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#2D4C82").s().p("AAOBbIgLgJIAAgUQABhSgUhGQAKAFAGAJIAAAAQAUBHgEBZIgBAHIgBAAg");
	this.shape_74.setTransform(66.3,25.8);
...
(lib.stars = function(mode,startPosition,loop) {
    ...
    this.instance.cache(-77.3,0,2048,500);
...
(lib.ship = function(mode,startPosition,loop) {
	...
	// ship
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#231F20").s().p("AglBsIgBgFIgJADIgbgGIgBgEIgKACIhvgWIgCgGIgJADIgBAAQgKgRAAgjIAKgBQgCgUABgXQDFAUCmgUIABAAIAAAAIA9gPQALAxgiA8QgYArghAdgAi8h2QAGgMAGgMIB5ATIAIAFIACgDIAVADIAJAFIACgDIAiAGQhrgBhmgHg");
	this.shape.setTransform(301.2,333.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#BFBEBE").s().p("");
	this.shape_1.setTransform(268.8,287.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#575959").s().p("Ag9BvIBEABIARjRICpAHIAsDNIkqApgAjPCBIgdkOICBAJIAJDyIARAAIAAAtgAiCiZIAWgCIAAADg");
	this.shape_2.setTransform(97,296.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4E59A6").s().p("AoeGUQDMgMDagtIBLgPIAAATIAADEInrAdgAinC4IgGgBIgagHIBFgKIACgDQBlhjAukdQAPhZAJhhIAAgBIAEhHIHwhgIAAJ4QjEAPjDAdQhjAPgyBGg");
	this.shape_3.setTransform(138.2,153.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#314184").s().p("AphEVIAAp4IABAAITCCPIAAI4g");
	this.shape_4.setTransform(255.5,131.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#AFC0E3").s().p("");
	this.shape_5.setTransform(254.1,137.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#4F5154").s().p("");
	this.shape_6.setTransform(266.7,138);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#9B9C9F").s().p("");
	this.shape_7.setTransform(203,346.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#6A6C71").s().p("");
	this.shape_8.setTransform(228.1,190.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#CDCDCD").s().p("");
	this.shape_9.setTransform(222.9,191.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#D3BBDA").s().p("");
	this.shape_10.setTransform(198.9,182.4);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#5A595B").s().p("");
	this.shape_11.setTransform(206.7,267.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("");
	this.shape_12.setTransform(199.5,191.5);
...
(lib.lab_machine01 = function() {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#CCCCCC").ss(2).p("AmpFEINDhSAmpIBINDA6AGqLUItTANAmpBPINTAmAmpmPINDglAGqhXItThTAmpstINDAwAGqp5ItTAAAGquuItThwAmpPZINTBG");
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#127E7B").s().p("AmpSWIAAjzIAAj4IAAjgIAAi9IAAj1IAAj5IAAjlIAAjrIAAi0IAAjxINTBxIAAE0ItTAAINTAAIAAIjItThTINTBTIAADMItTgmINTAmIAAJfItTANINTgNIAAFLItThGINTBGIAADbgAGaIFItDg6gAmpEOINDhSgAmpnFINDglgAGas0ItDgwgAGqPpgAGqKegAGqvkgAGqvkItThxIAAhuINTAtIAACyg");
...
(lib.lab_computer02 = function(mode,startPosition,loop) {
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#0F4A46").p("AGrmpIAiFmAIthzIAQlwAKGigIgIldANrpdIAHFGALRofIApFFAMyj2IAElRApmgBIAAHMAtwJeIgBnzArMILIgmnUAFUmGIAAGAIAAAFAmAFlIACnDAoUGvIAVnYADnAvIAFmIAisD6IgsmbAAqCOIgtmFAB1BoIAGmTAj7EiIghmoAhRjYIAAGf");
	this.shape_4.setTransform(356.1,397.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#0F4A46").ss(4).p("EAOvggOMAAAA0QIgjAOIg2AWIhkAoIhUAhIhAAaIiRA7IgBAAIhXAjI0wIW");
	this.shape_5.setTransform(352.8,207.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#0D3734").p("");
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#27C2B6").s().p("");
...
(lib.Blue_character_handthrowlNEW = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(16).to({rotation:2.9,x:81.9,y:163.9},2).to({regX:77.1,rotation:-3.2,x:81.2,y:156.9},3).wait(15).to({regX:77.2,rotation:-3.2,x:81.3},0).to({regX:76.9,rotation:0,x:84.1,y:159.3},7).wait(3));
...
(lib.anime = function(mode,startPosition,loop) {
	...
	*/
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(14).to({_off:false},0).to({x:594.5},70,cjs.Ease.get(0.8)).wait(133).to({regX:184.1,regY:181.5,scaleX:1,scaleY:1,x:579.1,y:334.9},0).wait(1).to({scaleX:1.01,scaleY:1.01,x:579},0).wait(1).to({scaleX:1.01,scaleY:1.01,x:578.9,y:334.8},0).wait(1).to({scaleX:1.02,scaleY:1.02,x:578.8,y:334.6},0).wait(1).to({scaleX:1.04,scaleY:1.04,x:578.5,y:334.4},0).wait(1).to({scaleX:1.06,scaleY:1.06,x:578.3,y:334.3},0).wait(1).to({scaleX:1.08,scaleY:1.08,x:577.9,y:334},0).wait(1).to({scaleX:1.1,scaleY:1.1,x:577.6,y:333.7},0).wait(1).to({scaleX:1.13,scaleY:1.13,x:577.2,y:333.5},0).wait(1).to({scaleX:1.16,scaleY:1.16,x:576.7,y:333.1},0).wait(1).to({scaleX:1.19,scaleY:1.19,x:576.2,y:332.7},0).wait(1).to({scaleX:1.23,scaleY:1.23,x:575.7,y:332.3},0).wait(1).to({scaleX:1.26,scaleY:1.26,x:575,y:331.8},0).wait(1).to({scaleX:1.31,scaleY:1.31,x:574.4,y:331.4},0).wait(1).to({scaleX:1.36,scaleY:1.36,x:573.7,y:330.8},0).wait(1).to({scaleX:1.4,scaleY:1.4,x:572.9,y:330.3},0).wait(1).to({scaleX:1.46,scaleY:1.46,x:572.1,y:329.7},0).wait(1).to({scaleX:1.51,scaleY:1.51,x:571.2,y:329},0).wait(1).to({scaleX:1.57,scaleY:1.57,x:570.3,y:328.4},0).wait(1).to({scaleX:1.63,scaleY:1.63,x:569.4,y:327.7},0).wait(1).to({scaleX:1.69,scaleY:1.69,x:568.5,y:326.9},0).wait(1).to({scaleX:1.76,scaleY:1.76,x:567.5,y:326.2},0).wait(1).to({scaleX:1.82,scaleY:1.82,x:566.4,y:325.5},0).wait(1).to({scaleX:1.89,scaleY:1.89,x:565.4,y:324.7},0).wait(1).to({scaleX:1.96,scaleY:1.96,x:564.4,y:323.9},0).wait(1).to({scaleX:2.03,scaleY:2.03,x:563.3,y:323.1},0).wait(1).to({scaleX:2.1,scaleY:2.1,x:562.2,y:322.3},0).wait(1).to({scaleX:2.17,scaleY:2.17,x:561.1,y:321.5},0).wait(1).to({scaleX:2.24,scaleY:2.24,x:560.1,y:320.7},0).wait(1).to({scaleX:2.31,scaleY:2.31,x:559,y:319.9},0).wait(1).to({scaleX:2.37,scaleY:2.37,x:558,y:319.2},0).wait(1).to({scaleX:2.44,scaleY:2.44,x:557,y:318.4},0).wait(1).to({scaleX:2.5,scaleY:2.5,x:556.1,y:317.7},0).wait(1).to({scaleX:2.56,scaleY:2.56,x:555.1,y:317},0).wait(1).to({scaleX:2.62,scaleY:2.62,x:554.2,y:316.3},0).wait(1).to({scaleX:2.67,scaleY:2.67,x:553.4,y:315.7},0).wait(1).to({scaleX:2.72,scaleY:2.72,x:552.7,y:315.1},0).wait(1).to({scaleX:2.77,scaleY:2.77,x:551.9,y:314.6},0).wait(1).to({scaleX:2.81,scaleY:2.81,x:551.2,y:314.1},0).wait(1).to({scaleX:2.85,scaleY:2.85,x:550.7,y:313.7},0).wait(1).to({scaleX:2.89,scaleY:2.89,x:550.2,y:313.2},0).wait(1).to({scaleX:2.92,scaleY:2.92,x:549.7,y:312.9},0).wait(1).to({scaleX:2.94,scaleY:2.94,x:549.3,y:312.6},0).wait(1).to({scaleX:2.96,scaleY:2.96,x:549,y:312.4},0).wait(1).to({scaleX:2.98,scaleY:2.98,x:548.7,y:312.2},0).wait(1).to({scaleX:2.99,scaleY:2.99,x:548.6,y:312.1},0).wait(1).to({scaleX:3,scaleY:3,x:548.5,y:312},0).wait(1).to({regX:199.5,regY:193,scaleX:3,scaleY:3,x:594.6,y:346.4},0).to({_off:true},1).wait(589));
...
(lib.scene = function() {
	...
	this.instance.setTransform(562.8,341.3,1,1,0,0,0,625,375);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(415.5,262.7,2388.4,834);
