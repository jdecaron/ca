...
(lib.orange_mouth_talk = function(mode,startPosition,loop) {
	...
	this.shape_8.graphics.f().s("#D18B25").ss(2,1,1).p("AgzhIQAWgfAdAAQAeAAAVAfQAWAeAAAqQAAAqgWAfQgVAegeAAQgdAAgWgeQgVgfAAgqQAAgqAVgeg");
	...
	this.shape_12.graphics.f().s("#D18B25").ss(2,1,1).p("AiVAAQAAhWAsg/QAsg+A9AAQA+AAArA+QAtA/AABWQAABYgtA+QgrA+g+AAQg9AAgsg+Qgsg+AAhYg");
	...
	this.shape_16.graphics.f().s("#D18B25").ss(2,1,1).p("AIPgdQgVBZgrBQQggA5guAtQg0AyhFAVQhWAYhaACQiQACiHg6Qhegog/hPQgbgigVglQgphcgohZQgthmgbhsQgDgNgDgOQBnAqBtAfQBYAbBaAMQB9ARB9gIQBngDBkgTQBWgRBQgkQA2gYAwgjQgBBZgHBYQgGBEgPBAg");
...
(lib.ball = function() {
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#D1D1CF").s().p("AAYAIIgCAAQgWgIgYgGIAAgCQAcAFAVALg");
	this.shape_8.setTransform(41,32);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#010101").s().p("AgWB1Qg2gxgng/IAAgCIABgCIABgBIAAgBQAghAAqg1IACAAQAVABARAFIABAAQAWADASAGIACAAQAZAHAXAIIACABQADACAEABIACABIAAABQAKBHADBJIgBABQg8AlhMATIgBgCg");
	this.shape_9.setTransform(34,41.7);
	...
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#111211").s().p("");
	this.shape_11.setTransform(35.1,34.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#F5F8F0").s().p("");
	this.shape_12.setTransform(33.6,21.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#1A1A1A").s().p("ABBBVQg1gLg3gJIAAgCQABgFgDgBIAAgBIgghyQAhgMAegPIACAAQA3AvAiBEIABACQAAAJgCAHIAAACIgBAAQABAYgJAMIgCgBg");
	this.shape_13.setTransform(56.8,18.6);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#CDDCB9").s().p("");
	this.shape_14.setTransform(37,42.6);
...
(lib.ship = function(mode,startPosition,loop) {
	...
	// ship
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#06070C").p("");
	this.shape.setTransform(268.9,287.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#231F20").ss(1.2).p("ABlkIQg/AKgzA5QhFBLgJBsQgKBvApBEQAuBLBtAbABlkIQATgDAVACAA3ELQgsgLgfgRQg0gcgcguQgqhEAKhvQAKhsBEhLQBEhLBXAI");
	this.shape_1.setTransform(98.5,348);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1.6).p("AA5BnQgvARgwAAQgpAAgdgjQgdgjAAgyQAAgxAdgjQABgBABgBQAcghAoAAQAGAAAGABIAiAKQAdAMAkAaQAAAAABABQAhAZAQAXQATAYgFAYQgKAvhAAaQgDABgDACg");
	this.shape_2.setTransform(151.2,354.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(2.3).p("ACIhFQgFgMgFgLQgJgQgLgNQgqgzg6AAQgoAAghAZQgNALgNAPQgHAIgGAJQgdAtAAA7QAABIAqAzQAqAzA5AAQA6AAAqgzQAIgKAGgK");
	this.shape_3.setTransform(144.9,354.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#231F20").ss(2.3).p("AhKEUQgzgVgpgyQhFhVAAh4QAAhLAcg+QALgZAQgWQAGgKAIgKQBEhTBfgCQACAAABAAQBiAABFBVQAxA7AOBMQAGAbABAeQAAAGAAAGQAAB4hGBVQhFBVhiAAQgnAAgjgOg");
	this.shape_4.setTransform(143.2,354.2);
	...
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#231F20").p("");
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#231F20").ss(1.1).p("AgUDtQAmAHAmgJQBWgVAshTQAshUgXhfQgXhehJg3QhKg2hRAPIgLADQhWAUgsBUQgsBTAXBgQASBKA0AzQAyAyBCAMIALgCQBUgVAshTQAshUgXhfQgShKg0g0Qgzgyg/gM");
	this.shape_9.setTransform(255.1,64.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#231F20").ss(1.7).p("AQAGdQg0gKhTgNQhTgMhTgKAuDGUIhUgOIgBgxIglwQQgFgmAIgpQARhRBDgJQB+gTB5gMIAlUDIACA3IAAACIAAABIg3gJAsBMQIALADIGRlDIgfgKAFwHgQAQgsAhgiQAEgEAFgFAPEOFQiKgbidgtIhggdIhAgUQhegYglg7QgJgPgGgSAFgIrQgCAfACAa");
	this.shape_10.setTransform(244,274.4);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#231F20").ss(1.4).p("");
	...
	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#231F20").ss(2).p("");
	this.shape_13.setTransform(222.9,182.8);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#000000").ss(2).p("");
	...
	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#BFBEBE").s().p("");
	...
	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#4F5154").s().p("");
	this.shape_20.setTransform(264.3,138);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#AFC0E3").s().p("");
	this.shape_21.setTransform(254.1,137.7);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#6A6C71").s().p("");
	this.shape_22.setTransform(227,190.3);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#9B9C9F").s().p("");
	this.shape_23.setTransform(205.5,346.5);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#CDCDCD").s().p("");
	this.shape_24.setTransform(222.9,191.6);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#5A595B").s().p("");
...
(lib.lab_machine01 = function() {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#CCCCCC").ss(2).p("AGqp5ItTAAAmpstINDAwAGqhXItThTAmpmPINDglAmpBPINTAmAGqLUItTANAmpIBINDA6AmpFEINDhSAGquuItThwAmpPZINTBG");
...
(lib.lab_computer02 = function(mode,startPosition,loop) {
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#27C2B6").s().p("");
...
(lib.Blue_character_handthrowlNEW = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(16).to({rotation:2.9,x:81.9,y:163.9},2).to({regX:77,rotation:-3.2,x:81.1,y:156.9},3).wait(15).to({regX:77.1,rotation:-3.2,x:81.2},0).to({regX:76.9,rotation:0,x:84.1,y:159.3},7).wait(3));
...
(lib.anime = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(1).call(this.frame_1).wait(326).call(this.frame_327).wait(22).call(this.frame_349).wait(18).call(this.frame_367).wait(61).call(this.frame_428).wait(71).call(this.frame_499).wait(36).call(this.frame_535).wait(21).call(this.frame_556).wait(10).call(this.frame_566).wait(29).call(this.frame_595).wait(42).call(this.frame_637).wait(48).call(this.frame_685).wait(52).call(this.frame_737).wait(5).call(this.frame_742).wait(16).call(this.frame_758).wait(2).call(this.frame_760).wait(94));
...
p.nominalBounds = new cjs.Rectangle(427.7,271.5,2388.4,834);
