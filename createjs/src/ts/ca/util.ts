...
export function calculateIntersection(rect1, rect2, x, y)
{
...
export function calculateCollision(obj, direction, collideables, moveBy)
{
    ...
    var measure = direction == 'x' ? 'width' : 'height',
        ...
        bounds = {x:obj.x, y:obj.y, width:48, height:48},
        cbounds,
        collision = null,
        cc = 0;
