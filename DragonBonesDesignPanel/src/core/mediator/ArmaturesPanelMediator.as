		...
		private function modelHandler(e:ModelEvent):void
		{
			...
			switch(e.type)
			{
				...
				case ModelEvent.PARSED_MODEL_SKIN_CHANGE:
					view.armatureView.armature = parsedModel.factory.buildArmature(parsedModel.armatureSelected.name, null, null, parsedModel.skinSelected?parsedModel.skinSelected.name:null);
