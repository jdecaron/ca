	...
	public final class ImportFileService extends _BaseService
	{
		...
		private function importMergedData(dataType:String):Boolean
		{
			try
			{
				...
				var decompressedData:DecompressedData = DataSerializer.decompressData(importModel.vo.data);    // decompress error
				...
				importModel.vo.textureAtlasBytes = decompressedData.textureAtlasBytes;
