package core.model
{
	...
	public final class ParsedModel extends _BaseModel
	{
		...
		public function setDataFromImport(importVO:ImportVO):void
		{
			...
			_vo.skeleton = XMLDataParser.parseDragonBonesData(importVO.skeleton);
			...
			armatureSelected = _armatureSelected?(_vo.skeleton.getArmatureDataByName(_armatureSelected.name)||_vo.skeleton.armatureDataList[0]):_vo.skeleton.armatureDataList[0];
		}
