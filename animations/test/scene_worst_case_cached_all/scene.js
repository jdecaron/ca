...
(lib.Symbole2 = function() {
	...
	this.shape_13.graphics.f().s("#231F20").ss(2).p("");
...
p.nominalBounds = new cjs.Rectangle(-1.1,-1.1,401.1,385.5);
...
(lib.ship = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(260,329.9,1,1,0,0,0,62.6,32.9);
	...
	this.instance_2.setTransform(38,337.7,1,1,0,0,0,62.6,32.9);
	this.instance_2.shadow = new cjs.Shadow("rgba(255,255,204,1)",0,0,5);
	this.instance_2.filters = [new cjs.BlurFilter(8, 8, 3)];
	this.instance_2.cache(-2,-2,129,70);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2,p:{scaleX:1,scaleY:1}},{t:this.instance_1,p:{scaleX:1,scaleY:1}}]}).to({state:[{t:this.instance_2,p:{scaleX:0.95,scaleY:0.95}},{t:this.instance_1,p:{scaleX:0.95,scaleY:0.95}}]},2).wait(2));
