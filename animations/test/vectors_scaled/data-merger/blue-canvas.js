...
(lib.Blue_character_walk = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(104.3,85.3,1.226,1.226,0,0,0,41,33.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:33.2,rotation:-2.2,x:97.3,y:78.3},6).to({regY:33.1,rotation:0,x:112.3,y:85.3},5).wait(1).to({regY:33.2,rotation:-2.2,x:97.3,y:82.3},5).to({regY:33.1,rotation:0,x:104.3,y:85.3},6).wait(1));

	// blue_arm_R
	this.instance_1 = new lib.blue_arm_R();
	this.instance_1.setTransform(40.8,158.7,1.226,1.226,-9.5,0,0,18.2,4.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleY:1.27,rotation:0,skewX:4.1,skewY:4.4,x:36.8,y:151.9},6).to({scaleY:1.23,rotation:19,skewX:0,skewY:0,x:55.7,y:158.8},5).wait(1).to({scaleY:1.21,rotation:0,skewX:4.3,skewY:4.2,x:36.8,y:157.7},5).to({scaleY:1.23,rotation:-9.5,skewX:0,skewY:0,x:40.8,y:158.7},6).wait(1));

	// blue_mouth
	this.instance_2 = new lib.blue_mouth();
	this.instance_2.setTransform(98.7,139.1,1.226,1.226,0,0,0,30.4,12);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleY:1.27,skewX:-2.1,skewY:-2.3,x:93.9,y:129.3},6).to({scaleY:1.23,skewX:0,skewY:0,x:106.8,y:139.1},5).wait(1).to({rotation:-2.2,x:93.9,y:134.1},5).to({rotation:0,x:98.7,y:139.1},6).wait(1));

	// blue_body_legs
	this.instance_3 = new lib.blue_body_legs();
	this.instance_3.setTransform(94.4,189.4,1.226,1.226,0,0,0,77,124.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regY:124.8,scaleY:1.25,skewX:-2.2,skewY:-2.3,x:91.5,y:182.5},6).to({regY:124.9,scaleY:1.23,skewX:0,skewY:0,x:94.4,y:189.4},5).wait(1).to({regY:124.8,scaleY:1.21,skewX:-2.2,skewY:-2.2,x:91.5,y:185.7},5).to({regY:124.9,scaleY:1.23,skewX:0,skewY:0,x:94.4,y:189.4},6).wait(1));

	// blue_ear_R
	this.instance_4 = new lib.blue_ear_R();
	this.instance_4.setTransform(29.9,54.1,1.226,1.226,0,0,0,12.6,38.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleY:1.25,skewX:-2.2,skewY:-2.3,x:21.8,y:47.1},6).to({scaleY:1.23,rotation:6.2,skewX:0,skewY:0,x:32.6,y:54.1},5).wait(1).to({scaleY:1.21,rotation:0,skewX:-2.2,skewY:-2.2,x:21.8,y:55.1},5).to({scaleY:1.23,skewX:0,skewY:0,x:29.9,y:54.1},6).wait(1));

	// blue_ear_L
	this.instance_5 = new lib.blue_ear_L();
	this.instance_5.setTransform(97,38.7,1.226,1.226,0,0,0,15.2,30.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({scaleY:1.25,skewX:-2.2,skewY:-2.3,x:88.2,y:27.8},6).to({scaleY:1.23,rotation:4.5,skewX:0,skewY:0,x:96.9,y:41.1},5).wait(1).to({regY:31,scaleY:1.21,rotation:0,skewX:-2.2,skewY:-2.2,x:88.2,y:36.7},5).to({regY:30.9,scaleY:1.23,skewX:0,skewY:0,x:97,y:38.7},6).wait(1));

	// blue_leg_L
	this.instance_6 = new lib.blue_leg_L();
	this.instance_6.setTransform(98.5,247.3,1,1,0,0,0,5.2,5);

	this.instance_7 = new lib.blue_leg_L_01();
	this.instance_7.setTransform(45.2,235,1,1,0,0,0,5.2,5);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({x:45.2},10).to({_off:true},2).wait(5).to({_off:false,x:98.5},5).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(13).to({_off:false},0).to({x:71.9,y:228.9},5).to({_off:true,x:98.5,y:247.3},5).wait(1));

	// blue_leg_R
	this.instance_8 = new lib.blue_leg_R();
	this.instance_8.setTransform(38.2,250.9,1,1,0,0,0,8.8,3.6);

	this.instance_9 = new lib.blue_leg_R_01();
	this.instance_9.setTransform(38.2,240.7,1,1,0,0,0,8.8,3.6);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true},1).wait(5).to({_off:false,x:62.8},5).wait(2).to({x:38.2},10).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({_off:false},0).to({x:48.1,y:234.5},5).to({_off:true,x:62.8,y:250.9},5).wait(13));

	// blue_arm_L
	this.instance_10 = new lib.blue_arm_L();
	this.instance_10.setTransform(137.2,153.3,1.226,1.226,0,-127.2,52.8,0.1,76.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({skewX:-142.6,skewY:37.4,x:133,y:146.8},6).to({skewX:-164.9,skewY:15.1,x:122.2,y:153.3},5).wait(1).to({skewY:15.1},0).to({regX:0,skewX:-142.4,skewY:37.6,x:132.9,y:146.8},5).to({regX:0.1,skewX:-127.2,skewY:52.8,x:137.2,y:153.3},6).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0.8,184.6,320.7);
...
(lib.bluecanvas = function() {
	this.initialize();

	// Calque 1
	this.instance = new lib.Blue_character_walk();
	this.instance.setTransform(274.9,210.5,1,1,0,0,0,94.5,171.2);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(455.4,240.1,184.6,320.7);
